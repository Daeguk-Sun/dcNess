...
cycle 한도 = 각 loop skill 의 `<skill>-routing.md` §retry ([`architect-loop-routing.md`](../../skills/architect-loop/architect-loop-routing.md#retry-한도) / [`impl-loop-routing.md`](../../skills/impl-loop/impl-loop-routing.md#retry-한도)).
...
- 본 문서 §3.1 + [Step 8 — review 결과 인지](#step-8-review-결과-인지) — echo / 자가점검 / REDO 분류 / 개선점 코멘트 (옛 dcness-rules §3/§4 흡수)
