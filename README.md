...
|---|---|---|---|---|
| 하네스·기계적 guard | unittest 1,895/1,895 PASS, 결정적 guard 39/39 PASS | test 1,895, guard case 39 / dcNess checkout 1 | `node scripts/check_public_evidence.mjs` | 보안 증명이나 제품 성공률이 아니다 |
