...
- impl/compact plan, validator finding, prompt 에 invariant/ordering/error mode/config/forbidden alternative 사본을 만들지 않는다. 필요한 곳은 module id 와 decision id/link 를 가리킨다.
