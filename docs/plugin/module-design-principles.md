...
- Contract Ledger 충분성 — epic architecture.md 의 `## Contract Ledger` 가 signature 만 적고 invariant/ordering/error mode/forbidden alternative 를 빠뜨린 *shallow contract* 가 아닌지
