...
description: >
  ...
  docs/plugin/agents/test-engineer/test-engineer-agent.md 에 있다.
...
1. [`docs/plugin/agents/test-engineer/test-engineer-agent.md`](../docs/plugin/agents/test-engineer/test-engineer-agent.md)를 읽는다.
2. 구현 코드를 읽지 않고 구현 계획과 설계 문서만으로 테스트를 작성한다.
3. 완료 보고는 [`templates/test-report.md`](../docs/plugin/agents/test-engineer/templates/test-report.md)를 참고한다.
