...
<!-- public-evidence-snapshot {"plugin_version":"0.23.0","measured_at":"2026-07-15","unit_tests":{"passed":1120,"total":1120},"guard":{"passed":39,"total":39},"source_project_count":2} -->
...
|---|---:|---|---|
| 전체 unit 계약 | 1,120/1,120 PASS | `python3.11 -m unittest discover -s tests -v` | source checkout 1개의 코드·문서 계약 |
