...
14. 완료 전에 구현 세부 유출, Story AC ↔ REQ 커버리지, 무출처 REQ, 마지막 task 전수 검증, Story 동작 슬라이스 증거, Agent Operability 증거, 코드 SSOT drift 를 다시 본다.
