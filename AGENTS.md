...
자세한 형식: [`agents/impl-validator.md`](agents/impl-validator.md), [`agents/architecture-validator.md`](agents/architecture-validator.md), [`CLAUDE.md`](CLAUDE.md#dcness-강제-원칙-룰-추가설계-시-가드레일).
