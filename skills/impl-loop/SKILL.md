...
- **expected_steps**: 4 (풀) / 5 (advanced fallback) / 2 (build-worker) · UI 풀 4-agent = 5 / UI build-worker = 3 / UI advanced fallback = 6 · story 마감 task +1 / epic 마감 task +2 (`product-acceptance`, 아래 `## 마감 acceptance`)
