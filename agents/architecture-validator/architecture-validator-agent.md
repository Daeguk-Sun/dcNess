...
- 공통/Story 단위 검증이면 신규 산출물의 Contract References 가 Ledger 행 키만 담고 전문 사본을 복제하지 않는지 검토했다.
