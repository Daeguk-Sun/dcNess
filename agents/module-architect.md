...
이 파일은 `module-architect`의 얇은 현행 진입점이다.
...
1. [`docs/plugin/agents/module-architect/module-architect-agent.md`](../docs/plugin/agents/module-architect/module-architect-agent.md)를 읽는다.
2. 그 문서의 목적, 판단 축, 권한 경계, 완료 기준을 기준으로 작업한다.
3. 구현 계획과 계약 전파 결과는 `docs/plugin/agents/module-architect/templates/`의 템플릿을 따른다.
