...
| Epic 완료 기준 | 여러 Story 가 함께 달성해야 할 epic 단위 결과를 정의한다. | Story 전체가 합쳐졌을 때 product-acceptance 가 통합 증거를 대조한다. | [`skills/spec/spec-stories-reference.md`](../../skills/spec/spec-stories-reference.md) |
