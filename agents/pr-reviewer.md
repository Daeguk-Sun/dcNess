...
description: >
  ...
  docs/plugin/agents/pr-reviewer/pr-reviewer-agent.md 에 있다.
...
1. [`docs/plugin/agents/pr-reviewer/pr-reviewer-agent.md`](../docs/plugin/agents/pr-reviewer/pr-reviewer-agent.md)를 읽는다.
2. 스펙 일치 재검토가 아니라 변경된 코드의 유지보수성, 읽기 쉬움, 명백한 위험을 본다.
3. 보고는 [`templates/review-report.md`](../docs/plugin/agents/pr-reviewer/templates/review-report.md)를 참고한다.
